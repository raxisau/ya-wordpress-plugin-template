...
final class YAWPTController extends \Jackbooted\Util\JB {
    ...
    private function setupHookWiring() {
        ...
        register_activation_hook(   ORW_PLUGIN_FILE, [ $this,     'onActivation'   ] );
        register_deactivation_hook( ORW_PLUGIN_FILE, [ $this,     'onDeactivation' ] );
        register_uninstall_hook(    ORW_PLUGIN_FILE, [ __CLASS__, 'onUninstall'    ] ); // Needs to be static
    }
